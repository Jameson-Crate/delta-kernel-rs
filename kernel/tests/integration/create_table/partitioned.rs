...
fn test_create_table_build_v2_error_boundary(
    ...
    let error = create_table(&table_path, schema, "Test/1.0")
        ...
        .build_v2(engine.as_ref(), Box::new(FileSystemCommitter::new()))
    ...
    match expected_condition {
        ...
        _ => unreachable!("test only covers migrated and legacy v2 errors"),
    }
}
