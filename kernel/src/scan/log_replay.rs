...
///   is processed.
/// - Parse-error fallback: If transformation and data skipping return a parse-classified kernel or
///   engine error, deduplicates the raw batch first, then retries transformation and data skipping
///   on the surviving actions.
